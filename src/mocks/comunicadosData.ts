...
export const mockComunicados: Comunicado[] = [
  {
    ...
    atualizadoEm: "2026-02-10T09:00:00",
  },
  {
    id: "com-2",
    titulo: "Campanha de Verão 2026 — Kit de Materiais",
    conteudo: "<p>A campanha de verão já está no ar! Acessem o Drive Corporativo para baixar os materiais gráficos atualizados.</p><p>Prazo para implementação nas unidades: até 28/02/2026.</p>",
    imagemUrl: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600",
    linkExterno: "https://drive.google.com",
    publico: ["Franqueados", "Clientes finais"],
    unidadesEspecificas: [],
    tipo: "Campanha",
    prioridade: "Alta",
    mostrarDashboard: true,
    ...
    autorId: "u3",
    autorNome: "Amanda",
    criadoEm: "2026-02-05T14:30:00",
    atualizadoEm: "2026-02-05T14:30:00",
  },
  {
    id: "com-3",
    titulo: "Atualização do Sistema v3.2 — Novo Módulo de Atendimento",
    conteudo: "<p>O sistema foi atualizado para a versão 3.2. Principais novidades:</p><ul><li>Kanban de atendimento com drag-and-drop</li><li>Filtros avançados por prioridade</li><li>Histórico de interações</li></ul><p>Recomendamos que todos acessem o módulo para se familiarizar.</p>",
    publico: ["Todos"],
    unidadesEspecificas: [],
    tipo: "Atualização de sistema",
    prioridade: "Normal",
    mostrarDashboard: true,
    mostrarPopup: false,
    exigirConfirmacao: false,
    ...
    autorId: "u2",
    autorNome: "Lucas",
    criadoEm: "2026-02-18T10:00:00",
    atualizadoEm: "2026-02-18T10:00:00",
  },
  {
    id: "com-4",
    titulo: "Convenção Nacional de Franqueados 2026",
    conteudo: "<p>A Convenção Nacional será realizada nos dias 15 e 16 de abril em São Paulo. Inscrições abertas a partir de 01/03/2026.</p><p>Mais detalhes serão enviados por e-mail.</p>",
    publico: ["Franqueados", "Franqueadora"],
    unidadesEspecificas: [],
    tipo: "Institucional",
    prioridade: "Normal",
    mostrarDashboard: true,
    mostrarPopup: false,
    exigirConfirmacao: false,
    dataProgramada: "2026-03-01T08:00:00",
    status: "Programado",
    autorId: "u1",
    autorNome: "Davi",
    criadoEm: "2026-02-20T16:00:00",
    atualizadoEm: "2026-02-20T16:00:00",
  },
  {
    id: "com-5",
    titulo: "Promoção Black Friday 2025 — Encerrada",
    conteudo: "<p>A campanha Black Friday 2025 foi encerrada com sucesso. Resultados consolidados disponíveis no módulo Metas & Ranking.</p>",
    publico: ["Franqueados"],
    unidadesEspecificas: [],
    tipo: "Campanha",
    prioridade: "Normal",
    ...
    mostrarPopup: false,
    exigirConfirmacao: false,
    dataExpiracao: "2025-12-01T23:59:00",
    status: "Expirado",
    autorId: "u3",
    autorNome: "Amanda",
    criadoEm: "2025-11-20T09:00:00",
    atualizadoEm: "2025-12-01T23:59:00",
  },
  {
    id: "com-6",
    titulo: "Nova Política de Trocas e Devoluções",
    conteudo: "<p>Rascunho da nova política de trocas. Aguardando aprovação jurídica antes de publicação.</p>",
    anexo: "politica-trocas-v2.pdf",
    publico: ["Franqueados", "Clientes finais"],
    unidadesEspecificas: [],
    tipo: "Informativo",
    prioridade: "Normal",
    ...
    autorId: "u2",
    autorNome: "Lucas",
    criadoEm: "2026-02-19T11:00:00",
    atualizadoEm: "2026-02-19T11:00:00",
  },
  {
    id: "com-7",
    titulo: "Boas-vindas aos Novos Colaboradores — Fevereiro 2026",
    conteudo: "<p>Damos as boas-vindas a todos os novos colaboradores que ingressaram na rede em fevereiro!</p><p>Acessem o módulo Treinamentos para completar o onboarding obrigatório.</p>",
    publico: ["Todos"],
    unidadesEspecificas: [],
    tipo: "Institucional",
    prioridade: "Normal",
  ...
  {
    id: "com-8",
    titulo: "Manutenção Programada — Servidor dia 25/02",
    conteudo: "<p><strong>Atenção:</strong> O sistema ficará indisponível das 02:00 às 06:00 do dia 25/02 para manutenção programada no servidor.</p><p>Planejem suas atividades com antecedência.</p>",
    ...
    autorId: "u2",
    autorNome: "Lucas",
    criadoEm: "2026-02-20T15:00:00",
    atualizadoEm: "2026-02-20T15:00:00",
  },
];
