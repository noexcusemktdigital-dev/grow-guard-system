...
export const mockUnidades: Unidade[] = [
  {
    id: "u1", nome: "Curitiba", cidade: "Curitiba", estado: "PR",
    responsavel: "Carlos Mendes", email: "curitiba@franquia.com", telefone: "(41) 99999-0001",
    dataInicio: "2023-03-15", status: "Ativa", observacoes: "Unidade matriz",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
  {
    id: "u2", nome: "N3W São Paulo", cidade: "São Paulo", estado: "SP",
    responsavel: "Fernanda Lima", email: "sp@franquia.com", telefone: "(11) 99999-0002",
    dataInicio: "2023-06-01", status: "Ativa", observacoes: "",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
  {
    id: "u3", nome: "Maringá – Gabriel", cidade: "Maringá", estado: "PR",
    responsavel: "Gabriel Souza", email: "gabriel.maringa@franquia.com", telefone: "(44) 99999-0003",
    dataInicio: "2023-09-10", status: "Ativa", observacoes: "",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
  {
    id: "u4", nome: "Maringá – Victor", cidade: "Maringá", estado: "PR",
    responsavel: "Victor Almeida", email: "victor.maringa@franquia.com", telefone: "(44) 99999-0004",
    dataInicio: "2024-01-20", status: "Ativa", observacoes: "",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
  {
    id: "u5", nome: "Bauru – Márcia", cidade: "Bauru", estado: "SP",
    responsavel: "Márcia Oliveira", email: "marcia.bauru@franquia.com", telefone: "(14) 99999-0005",
    dataInicio: "2024-04-01", status: "Ativa", observacoes: "",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
  {
    id: "u6", nome: "Batatais – Alisson", cidade: "Batatais", estado: "SP",
    responsavel: "Alisson Ferreira", email: "alisson.batatais@franquia.com", telefone: "(16) 99999-0006",
    dataInicio: "2024-07-15", status: "Ativa", observacoes: "",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
  {
    id: "u7", nome: "Bahia – Gregory", cidade: "Salvador", estado: "BA",
    responsavel: "Gregory Santos", email: "gregory.bahia@franquia.com", telefone: "(71) 99999-0007",
    dataInicio: "2024-10-01", status: "Ativa", observacoes: "",
    repassePercent: 20, royaltiesPercent: 1, mensalidadeSistema: 250, sistemaAtivo: true, observacoesFinanceiras: "",
  },
];
