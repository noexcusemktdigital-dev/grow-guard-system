import type {
  ...
  Ticket, TicketMessage, AtendimentoAlert,
...
export const SLA_DEADLINES: Record<TicketPriority, number> = {
  Urgente: 4, Alta: 8, Normal: 24, Baixa: 48,
};
...
export const mockTickets: Ticket[] = [
  { id: "t1", numero: "#001", unidadeId: "u1", unidadeNome: "Unidade Centro", categoria: "Financeiro", subcategoria: "Dúvida de repasse", prioridade: "Urgente", status: "Aberto", responsavelId: "r1", responsavelNome: "Davi", descricao: "Franqueado reporta divergência no valor de repasse do mês de janeiro. Solicita revisão urgente.", anexos: ["relatorio_jan.pdf"], slaDeadline: h(1), criadoEm: h(6), atualizadoEm: h(2) },
  { id: "t2", numero: "#002", unidadeId: "u2", unidadeNome: "Unidade Norte", categoria: "Sistema", subcategoria: "Bug", prioridade: "Alta", status: "Em analise", responsavelId: "r2", responsavelNome: "Lucas", descricao: "Sistema não gera relatório DRE corretamente. Valores de receita aparecem zerados.", anexos: [], slaDeadline: h(-2), criadoEm: h(12), atualizadoEm: h(4) },
  { id: "t3", numero: "#003", unidadeId: "u3", unidadeNome: "Unidade Sul", categoria: "Marketing", subcategoria: "Material de campanha", prioridade: "Normal", status: "Em atendimento", responsavelId: "r3", responsavelNome: "Amanda", descricao: "Precisa de artes para campanha de Dia das Mães. Formatos: stories e feed.", anexos: ["briefing.docx"], slaDeadline: future(12), criadoEm: h(20), atualizadoEm: h(3) },
  { id: "t4", numero: "#004", unidadeId: "u4", unidadeNome: "Unidade Leste", categoria: "Clientes", subcategoria: "Cancelamento", prioridade: "Alta", status: "Aguardando franqueado", responsavelId: "r1", responsavelNome: "Davi", descricao: "Cliente importante solicitou cancelamento. Aguardando franqueado enviar histórico de atendimento.", anexos: [], slaDeadline: future(2), criadoEm: h(30), atualizadoEm: h(50) },
  { id: "t5", numero: "#005", unidadeId: "u1", unidadeNome: "Unidade Centro", categoria: "Juridico", subcategoria: "Contrato", prioridade: "Normal", status: "Aberto", responsavelId: "r2", responsavelNome: "Lucas", descricao: "Dúvida sobre cláusula de exclusividade territorial no contrato de franquia.", anexos: ["contrato_v2.pdf"], slaDeadline: future(18), criadoEm: h(8), atualizadoEm: h(8) },
  { id: "t6", numero: "#006", unidadeId: "u5", unidadeNome: "Unidade Oeste", categoria: "Onboarding", subcategoria: "Etapa", prioridade: "Normal", status: "Em atendimento", responsavelId: "r3", responsavelNome: "Amanda", descricao: "Franqueado com dificuldade na etapa de configuração comercial do onboarding.", anexos: [], slaDeadline: future(10), criadoEm: h(15), atualizadoEm: h(5) },
  { id: "t7", numero: "#007", unidadeId: "u2", unidadeNome: "Unidade Norte", categoria: "Comercial", subcategoria: "Proposta", prioridade: "Baixa", status: "Resolvido", responsavelId: "r1", responsavelNome: "Davi", descricao: "Solicitação de modelo de proposta comercial atualizado.", anexos: ["proposta_modelo.pdf"], slaDeadline: future(30), avaliacao: 5, criadoEm: h(72), atualizadoEm: h(24) },
  { id: "t8", numero: "#008", unidadeId: "u3", unidadeNome: "Unidade Sul", categoria: "Academy", subcategoria: "Certificado", prioridade: "Baixa", status: "Encerrado", responsavelId: "r2", responsavelNome: "Lucas", descricao: "Certificado do módulo de vendas não foi gerado após conclusão da prova.", anexos: [], slaDeadline: future(40), avaliacao: 4, criadoEm: h(96), atualizadoEm: h(48) },
  { id: "t9", numero: "#009", unidadeId: "u6", unidadeNome: "Unidade Jardins", categoria: "Geral", subcategoria: "Sugestão", prioridade: "Baixa", status: "Aberto", responsavelId: "r3", responsavelNome: "Amanda", descricao: "Sugestão de melhoria no dashboard: incluir gráfico comparativo mensal.", anexos: [], slaDeadline: future(36), criadoEm: h(10), atualizadoEm: h(10) },
  { id: "t10", numero: "#010", unidadeId: "u7", unidadeNome: "Unidade Paulista", categoria: "Sistema", subcategoria: "Acesso", prioridade: "Urgente", status: "Em analise", responsavelId: "r1", responsavelNome: "Davi", descricao: "Funcionário novo não consegue acessar o sistema. Permissões não foram atribuídas.", anexos: [], slaDeadline: future(1), criadoEm: h(3), atualizadoEm: h(1) },
];
