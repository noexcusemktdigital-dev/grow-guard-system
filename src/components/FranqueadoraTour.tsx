...
import { Rocket, Building2, TrendingUp, Zap, Shield, X } from "lucide-react";

const STORAGE_KEY = "franqueadora_tour_done";
...
const STEPS: TourStep[] = [
  {
    icon: Rocket,
    title: "Bem-vindo à Franqueadora! 🚀",
    description: "Vamos fazer um tour rápido pelas principais áreas para você gerenciar sua rede com eficiência.",
    position: "center",
  },
  {
    icon: Building2,
    title: "Rede",
    description: "Gerencie suas unidades franqueadas, acompanhe atendimentos e controle o onboarding de novos franqueados.",
    target: "rede",
    position: "right",
  },
  {
  ...
  },
  {
    ...
    description: "Distribua materiais de marketing para a rede e crie treinamentos no Academy para capacitar seus franqueados.",
  ...
  },
  {
    icon: Shield,
    title: "Gestão",
    description: "Administre sua matriz, gerencie contratos, controle financeiro e monitore logs do sistema.",
    target: "gestao",
    position: "right",
  },
];

export function FranqueadoraTour() {
