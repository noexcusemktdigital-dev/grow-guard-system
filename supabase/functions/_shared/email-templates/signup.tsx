...
export const SignupEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme seu e-mail — NoExcuse Digital</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="NoExcuse Digital" width="160" height="auto" style={logo} />
        <Heading style={h1}>Confirme seu e-mail</Heading>
        <Text style={text}>
          Bem-vindo à <strong>NoExcuse Digital</strong>! Para ativar sua conta, confirme seu e-mail clicando no botão abaixo.
        </Text>
